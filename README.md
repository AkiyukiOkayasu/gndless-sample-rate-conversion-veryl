...
sample portは`FixedPointValue::<FORMAT>`で指定し、`LinearAsrc`、`ContinuousLinearAsrc`、Cubic、2x/4x halfband ASRCの既定formatはQ2.23です。ADATのQ1.23 PCMを接続する場合は、境界に`FormatConverter`を置いてQ2.23へ変換します。
